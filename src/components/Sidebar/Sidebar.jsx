...
const Sidebar = ({ activeMenu, setActiveMenu }) => {
    ...
    return (
        <div className=" transition-all sticky top-0 h-screen w-[300px] flex-none sidebar  bg-primary md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10 pt-5 caret-transparent">
