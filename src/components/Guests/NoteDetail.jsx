...
const NoteDetail = () => {
    return(
        <div className='flex flex-row'>  
            <div className='bg-[#D9D9D9] flex flex-col flex-start h-screen  w-[300px]'>
            ...
            <div className = 'w-full bg-[#F5F5F5] flex flex-col'>
                <div className=' flex flex-row  justify-center'>
                    <TextField required id="outlined-basic" label="Add notes here" variant="outlined" sx={{display: 'flex',flexGrow:1 ,flexWrap: 'wrap', mt: 5, mx: 5}}/>
